...
main_log_folder=config.Logs_Folder_Path+'/hardware_temprature_status/'



# Define average temperature thresholds
AVERAGE_CPU_TEMP = 70  # degrees Celsius, adjust based on your system
...
def get_temprature_status():
    ...
    "cpu_temprature": 0,
    "cpu_temperature_above_avg":{'flag':False,'threshold':AVERAGE_CPU_TEMP},
    "gpu_temprature": 0,
    "gpu_temperature_above_avg":{'flag':False,'threshold':AVERAGE_GPU_TEMP},
    "workingStatus":'Not_Found',
    ...
    if CPU_Status==False:
        report['cpu_temperature_above_avg']['flag']=True
    
    if GPU_Status==False:
        report['gpu_temperature_above_avg']['flag']=True
    ...
    return {'Message':'get_temprature_status Done','Execution_Time':f'{end-start:.2f} sec','report':report}
